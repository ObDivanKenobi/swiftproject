...
///
/// It should be used in conjunction with a <code>SyncUser
/// </code>'s management Realm.
///
...
/// Pass <code>nil
/// </code> if this offer should not expire.
///
...
/// This model is used to apply permission changes defined in the permission offer object represented by the specified token, which was created by another user's SyncPermissionOffer object.
///
/// It should be used in conjunction with a <code>SyncUser
/// </code>'s management Realm.
///
...
/// Construct a permission offer response object used to apply permission changes defined in the permission offer object represented by the specified token, which was created by another user's SyncPermissionOffer object.
///
/// \param token The received token which uniquely identifies another user's
/// <code>SyncPermissionOffer
/// </code>.
